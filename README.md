...
Senior Software Engineer at GoDaddy · Co-Founder & CTO at Anku Academy.

I work on backend and platform engineering, and on AI-native software
development — designing agentic workflows where AI agents take part in
planning, implementation, testing and delivery, not just code completion.
Recent example: [transcribe-local](https://github.com/renatogm24/transcribe-local),
